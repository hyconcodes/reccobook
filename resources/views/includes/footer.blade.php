        ...
        <div class="row gy-6 gy-xl-0 pb-8">
            <div class="col-xl-3 col-lg-12 col-md-6 col-12">
                <div class="d-flex flex-column gap-4">
                    <div>
                    <a class="navbar-brand fw-bold fs-4 text-primary" href="https://edu.recoobooks.xyz/home">Edu Resource Recommender</a>
                    </div>
                    <p class="mb-0">
                ...
                <div class="d-flex flex-column gap-5">
                    <div class="d-flex flex-column gap-3">
                        ...
                        <ul class="list-unstyled mb-0 d-flex flex-column nav nav-footer nav-x-0">
                            <li>
                                Toll free:
                                <span class="fw-semibold">+234 704 844 7856</span>
                            </li>
                            <li>
                                Time:
                    ...
                    <div class="d-flex flex-row gap-2 d-none">
